...
export const AuthProvider = ({ children }) => {
  ...
  const value = {
    currentUser,
    isAuthenticated: !!currentUser, // Boolean value indicating if the user is authenticated
    isAdmin: currentUser?.role === "admin", // Helper property to check if the user has admin privileges
    isLoading,
    login,
    logout,
  };
